...
constexpr static auto const WORK_PER_THREAD = 1'000ul;

TEST_CASE("lock-free stack with hazard pointer based reclamation supports construction")
{
    stack<int> s{};
...
TEST_CASE("lock-free stack with hazard pointer based reclamation supports concurrent operations")
{
